...
The goal is a calm, credible, premium operations dashboard that feels trustworthy for a franchise client, easy for non-technical users, and consistent across every workflow.

---

## 1. Product Context

Neuron Garage helps the team:
...
The UI should feel clean, white, calm, structured, premium but not flashy, operational rather than marketing-heavy, and easy to scan in a meeting/demo.
...
- Orange is not a main action color. Use orange only for warning, pending, or secondary accent states.

Avoid heavy gray blocks, purple gradients, large decorative gradients, dark dashboard panels, big shadows, orange primary CTAs, oversized chips, excessive nested borders, generic startup/AI styling, and random abstract graphics.
...
Micro Label:    10px-11px, 700 weight
...
Copy style should be operational, not vague marketing language. Prefer “Find teacher-operators for Frisco, TX,” “Promote to Candidate Pipeline,” “Sync Replies,” and “Add to Outreach Campaign.” Avoid “Unlock AI Magic,” “Supercharge Growth,” or “Revolutionary Outreach Intelligence.”
...
- Consistent page padding: 12px-24px depending on viewport.
...
- KPI cards should be compact, with icon left and text right.
...
Profile/details drawer pattern:

```text
Header: name/title, subtitle/location, key score badge
Sections: Contact, Background, AI Fit Score / Reasoning, Tags, Notes, Primary actions
```
...
Purpose: score and compare markets, choose a market, and move into Teacher Prospects.
...
Use Market, not City, when discussing the business opportunity. Main CTA: Find Teachers in This Market.

### 13.2 Teacher Prospects

Purpose: find teacher-operator prospects inside a selected market, review fit/contact enrichment, and add prospects to outreach or promote directly only when appropriate.
...
Workflow rule: Teacher Prospects should feed Email Outreach first. Promote to Pipeline is allowed for manually identified strong leads or interested prospects, but the normal workflow is Outreach first.

### 13.3 Email Outreach

Purpose: bridge Teacher Prospects and Candidate Pipeline. It should be a campaign control center.
...
```text
Header: Email Outreach or Frisco, TX Email Outreach; Export CSV; Sync Replies; Create Campaign
Summary cards: Active Campaigns; Prospects in Outreach; Replies; Interested Leads
Main left area: Campaign cards; Filters; Outreach prospects table
Right insight panel: Outreach Insights; Reply Status Breakdown; Recommended Next Step
```
...
MVP rule: Do not call paid/live email APIs automatically. Use sample data, safe toasts, and mock sync behavior until the real integration is approved.

### 13.4 Candidate Pipeline

Purpose: qualify interested prospects and move candidates through formal franchise qualification stages.
...
Purpose: manage signed/approved franchisees after candidate qualification. Track forms, documents, agreements, training, setup, and launch tasks.
...
If a live backend/API is not connected, buttons should either open a sample modal/drawer or show a clear safe MVP toast. Do not silently do nothing.
