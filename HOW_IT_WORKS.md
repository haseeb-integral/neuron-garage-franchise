...
- **Today's status (May 19):** `us_cities_scored` is the canonical city table — 948 cities with `composite_score_default` populated. City Detail drawer surfaces the full 46-metric registry across 4 chips (Pre-seeded / Not seeded yet / Tracked-no-value / Source unavailable).
