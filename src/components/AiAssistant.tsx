...
const SUGGESTIONS: Record<AssistantContext, { title: string; prompts: string[] }> = {
  general: {
    ...
    prompts: [
      ...
      "How do the scores work — can I trust them?",
      "What happens after a candidate signs?",
    ],
  },
  "city-search": {
    ...
    prompts: [
      ...
      "What does Tier A, B, C mean?",
      "How do I compare cities side-by-side?",
      "How do I adjust the weighting sliders?",
    ],
  },
  "teacher-search": {
    ...
    prompts: [
      ...
      "How do I bulk-tag teachers?",
      "What's the Outreach Intelligence panel?",
    ],
  },
  "email-outreach": {
    title: "About Email Outreach",
    prompts: [
      "How do I import prospects from Apollo?",
      "What do the four reply chips mean?",
      "How does AI personalization work?",
      "A teacher replied — what's my next step?",
    ],
  },
  "candidate-pipeline": {
    ...
    prompts: [
      ...
      "How does the qualification scorecard work?",
      "Why can't I drop a card into Signing?",
      "What's the Selection Committee?",
    ],
  },
};
