...
export const docProseClass =
  ...
  "prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-[#0b1a36] " +
  "prose-h1:text-[28px] prose-h1:font-bold prose-h1:mt-10 prose-h1:mb-4 " +
  "prose-h2:text-[24px] prose-h2:font-bold prose-h2:mt-12 prose-h2:mb-4 prose-h2:pt-8 prose-h2:border-t-2 prose-h2:border-[#FFD400] prose-h2:text-[#003c7e] " +
  "prose-h3:text-[17px] prose-h3:font-semibold prose-h3:mt-7 prose-h3:mb-2 prose-h3:text-[#0b1a36] " +
  "prose-h4:text-[13px] prose-h4:font-semibold prose-h4:uppercase prose-h4:tracking-[0.14em] prose-h4:text-[#003c7e] prose-h4:mt-5 prose-h4:mb-1.5 " +
  "prose-p:text-[14.5px] prose-p:leading-[1.75] prose-p:text-[#3a4a66] " +
  "prose-strong:text-[#0b1a36] prose-strong:font-semibold " +
  "prose-a:text-[#0757ff] prose-a:no-underline prose-a:font-medium hover:prose-a:underline " +
  "prose-li:text-[14.5px] prose-li:leading-[1.7] prose-li:text-[#3a4a66] prose-li:my-1 " +
  "prose-ul:my-3 prose-ol:my-3 " +
  "prose-code:rounded prose-code:bg-[#eef2f7] prose-code:px-1.5 prose-code:py-0.5 prose-code:text-[12.5px] prose-code:text-[#0b1a36] prose-code:font-medium prose-code:before:content-none prose-code:after:content-none " +
  ...
  "prose-table:text-[13.5px] prose-th:bg-[#fffaea] prose-th:text-[#0b1a36] prose-th:font-semibold prose-th:border prose-th:border-[#e3e9f3] prose-th:px-3 prose-th:py-2 prose-th:text-left prose-td:border prose-td:border-[#eef2f7] prose-td:text-[#3a4a66] prose-td:px-3 prose-td:py-2 prose-td:align-top " +
  "prose-blockquote:border-l-4 prose-blockquote:border-[#FFD400] prose-blockquote:bg-[#fffaea] prose-blockquote:rounded-r-xl prose-blockquote:py-1 prose-blockquote:px-4 prose-blockquote:not-italic prose-blockquote:text-[#3a4a66] prose-blockquote:font-normal " +
