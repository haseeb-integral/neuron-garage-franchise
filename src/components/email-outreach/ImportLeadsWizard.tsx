          ...
          {step === 1 && (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Field label="Source"><select value={source} onChange={(e) => setSource(e.target.value)} className="input">{["Apollo", "DonorsChoose", "Apify", "Manual CSV", "Other"].map((s) => <option key={s}>{s}</option>)}</select></Field>
