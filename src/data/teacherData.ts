...
export const sampleTeachers: TeacherProspect[] = [
  ...
  { id: 2, cityId: 1, name: "Marcus Johnson", school: "Pioneer Heritage Elementary", city: "Frisco", state: "TX",
    ...
    tags: ["Robotics"], notes: "" },
  { id: 13, cityId: 1, name: "Nadia Thompson", school: "Robertson Elementary", city: "Frisco", state: "TX",
    email: "nthompson@friscoisd.org", phone: "(469) 555-0443", linkedin: "linkedin.com/in/nadiathompson",
    fitScore: 82, tag: "High Potential", enrichmentStatus: "Enriched", gradeLevel: "3-5",
    yearsExperience: 9, hasSummerCampExp: true,
    aiReasoning: "Experienced elementary educator with robotics club involvement and recurring summer enrichment experience. Strong fit for a teacher-operator conversation.",
    tags: ["STEM", "Robotics"], notes: "" },
  { id: 14, cityId: 1, name: "Eric Wallace", school: "Bright Academy", city: "Frisco", state: "TX",
    email: "ewallace@frisco.edu", phone: "(469) 555-0478", linkedin: "linkedin.com/in/ericwallace",
    fitScore: 74, tag: "Follow-Up", enrichmentStatus: "Pending", gradeLevel: "6-8",
    yearsExperience: 6, hasSummerCampExp: true,
    aiReasoning: "Solid teaching profile with after-school coding club experience. Needs further enrichment to confirm franchise ownership interest.",
    tags: ["Coding Club"], notes: "" },
