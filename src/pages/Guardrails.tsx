...
import DOCS from "../../docs/architecture/guardrails.md?raw";
...
const Guardrails = () => {
  ...
  return (
    <DocShell
      ...
      title={<>Guardrails</>}
      subtitle="Plain-English overview of the safeguards that prevent staff (or a bad day) from breaking production data."
      action={
        <Button
