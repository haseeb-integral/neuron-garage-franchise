...
export default function MVSSpec() {
  return (
    <DocShell
      ...
      title="Market Validation Engine — v1.1 Full Spec"
    ...
    >
      <DocCard>
        <div className="space-y-12 text-[14px] leading-relaxed text-[#1a2540]">
          ...
          {/* 2. Scope table */}
          <section>
            <h2 className="text-lg font-bold text-[#07142f] mb-3">2. v1.1 scope (current)</h2>
...
Stage 4 → Score calculation            → 5 sub-scores → MVS composite`}
          ...
          <section>
            <h2 className="text-lg font-bold text-[#07142f] mb-3">5. Sub-score formulas + v1.1 reference ranges</h2>
          ...
          {/* 10. Out of scope */}
          <section>
            <h2 className="text-lg font-bold text-[#07142f] mb-3">10. Out of scope for v1.1 (do not drift)</h2>
