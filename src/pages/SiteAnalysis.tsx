    ...
    >
      ...
      {recomputed && (
        <div className="mt-3 space-y-1.5">
          ...
          <PillarBar label="Neighborhood Affluence" weight={0.25} value={recomputed.pillars.affluence} showFormula={showFormulas} detail={`0.6 × medianHHI_norm($${fmtK(slot.result?.signals?.acs10?.medianHhi)}) + 0.4 × pctAbove150k_norm(${fmtPct(slot.result?.signals?.acs10?.pctAbove150k)}) = ${recomputed.pillars.affluence}`} />
