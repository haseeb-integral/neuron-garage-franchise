...
import DOCS from "../../docs/architecture/system-overview.md?raw";
...
const SystemOverview = () => {
  ...
  return (
    <DocShell
      ...
      subtitle="One page covering what this app is, the AI models it uses, where data comes from, how it flows screen-to-screen, and the guardrails that keep it safe. Part A is for Brett; Part B is for developers."
      action={
        <Button
