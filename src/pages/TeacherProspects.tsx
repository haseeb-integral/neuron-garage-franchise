  ...
  return (
    <div className="-mx-3 -my-3 min-h-screen bg-white px-3 py-3 md:-mx-5 md:px-5 lg:-mx-6 lg:px-6">
      <div className="mx-auto w-full max-w-[1360px]">
        ...
        <div className="mb-3 grid gap-3 lg:grid-cols-4"><MetricCard title="Total Prospects" value="354" delta="25% vs last period" icon={<Users size={18} />} tone="cyan" /><MetricCard title="Shortlisted" value="86" delta="18% vs last period" icon={<Star size={18} />} tone="gold" /><MetricCard title="Contacted This Week" value="42" delta="31% vs last period" icon={<Mail size={18} />} tone="blue" /><MetricCard title="Promoted to Pipeline" value="23" delta="21% vs last period" icon={<ArrowRight size={18} />} tone="green" action={<button onClick={() => navigate("/candidate-pipeline")} className="text-[11px] font-bold text-[#174be8]">View All</button>} /></div>
