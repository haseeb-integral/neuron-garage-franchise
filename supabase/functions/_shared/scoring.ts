...
export const SOW_METRIC_REGISTRY: readonly SowMetricEntry[] = [
  ...
  { key: "young_family_growth_rate",            category: "demand", label: "Growth Rate of Young Families",           enabled: false, weight_within_category: 0,    status: "live"    },
  { key: "dual_income_household_pct",           category: "demand", label: "% Dual-Income Households",                enabled: false, weight_within_category: 0,    status: "live"    },
  ...
  { key: "waitlist_sold_out_signal_count",      category: "competitive_landscape", label: "Waitlist / Sold-Out Signals",               enabled: false, weight_within_category: 0,    status: "live"    },
