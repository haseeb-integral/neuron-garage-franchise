...
async function fetchCensusExpanded(city: string, state: string) {
  ...
  try {
    ...
    const vars = [
      ...
      'B09001_001E', // under 18 proxy
      'B15003_001E', // total 25+
      'B15003_022E', // bachelor's
      'B15003_023E', // master's
      'B15003_024E', // professional
      'B15003_025E', // doctorate
      'B19001_001E', // households total
      'B19001_014E', // $100-125k
      'B19001_015E', // $125-150k
      'B19001_016E', // $150-200k
      'B19001_017E', // $200k+
      'B11005_002E', // family households with own children under 18 proxy
      'B23025_005E', // unemployed civilian labor force proxy
    ...
    // ACS B01001 has 5-year bins. Ages 5-12 are estimated as full 5-9 + 3/5 of 10-14.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // This function intentionally replaces only market signals with the full SOW metric registry.
    // Competitors/category score tables remain controlled by the existing live data function.
